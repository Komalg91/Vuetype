...
const routes: Array<RouteRecordRaw> = [
  ...
  },
  {
    ...
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import(/* webpackChunkName: "about" */ '../views/Ourworld/Ourworld.vue')
  },
  {
    path: '/homepage',
    name: 'Homepage',
  ...
  },
  {
    ...
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import(/* webpackChunkName: "about" */ '../views/Experience/Experience.vue')
  },
  {
    path: '/carousel',
    name: 'Carousel',
  ...
  },
  {
    ...
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import(/* webpackChunkName: "about" */ '../views/Headernew.vue')
  },
]
